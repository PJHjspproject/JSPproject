	...
	<center>
		...
		<form action="CarOptionController.do" method="post">
			...
			<table width="1000" border="0" align="center">
				<tr align="center">
					<td rowspan="7" width="600"><img src="img/${param.carimg } "
						width="500"></td>
					<td align="center" width="200">대여기간</td>
					<td align="center"><select name="carreserveday">
				...
				<tr>
					<td align="center">무선WIFI적용</td>
					<td align="center"><select name="carwifi">
							<option value="0">비적용</option>
							<option value="1">WIFI사용(1일 1만원)</option>
					</select></td>
				</tr>
				<tr>
					<td align="center">네비게이션적용</td>
